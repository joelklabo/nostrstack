...
const postgresDefault = 'postgres://satoshis:satoshis@localhost:55432/satoshis';
...
const schema = z.object({
  ...
  LIGHTNING_PROVIDER: z.enum(['opennode', 'lnbits']).default('opennode'),
  ...
  OTEL_SERVICE_NAME: z.string().default('satoshis-api')
});
