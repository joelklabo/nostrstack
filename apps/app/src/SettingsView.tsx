    ...
    <div className="profile-view">
      ...
      <div className="paywall-container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            {permission === 'default' && (
              <button type="button" className="action-btn" onClick={requestPermission}>
      ...
      <div className="paywall-container nwc-card">
        ...
        {balanceSats !== null && (
          <div className="nwc-balance" role="status" aria-live="polite">
        ...
        {nwcLastPayment && (
          <div className="nwc-last-payment" role="status" aria-live="polite">
            <span
        ...
        <div className="nwc-form">
          <label className="nwc-label">
            ...
            <input
              ...
              aria-describedby={nwcUriError || nwcLimitError ? 'nwc-error' : undefined}
            />
          </label>
          <label className="nwc-label">
        ...
        {(nwcUriError || nwcLimitError) && (
          <div className="nwc-error" role="alert" id="nwc-error">
