...
export function ProfileView({ pubkey, onNavigateToSettings }: ProfileViewProps) {
  ...
  const displayName = profile?.display_name || profile?.name || 'UNKNOWN_USER';
  ...
  return (
    <div className="profile-view">
                    ...
                    <div className="lightning-card">
                      <div className="lightning-card-header">
                        ...
                        {lightningCopyStatus === 'error' && (
                          <span className="lightning-card-hint" role="alert">
                            COPY_FAILED
                          </span>
                        )}
                      </div>
                      <div className="lightning-card-body">
                        <div className="lightning-card-qr">
                          {lightningQr ? (
                            <img src={lightningQr} alt="Lightning QR" decoding="async" />
                          ) : (
                            <div
                              className="lightning-card-qr-fallback"
                              role="status"
                              aria-live="polite"
                            >
                              QR
      ...
      <h3>USER_ACTIVITY</h3>
      <div className="user-events" aria-busy={eventsLoading}>
        {eventsLoading ? (
          ...
          <p className="profile-empty" role="status" aria-live="polite">
            No posts yet. Check back soon.
          </p>
        ) : (
          <>
            <div className="profile-events-list" role="list">
              {events.map((event) => (
