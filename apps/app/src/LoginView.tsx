              ...
              {lnurlRequest && (
                <div className="ns-dialog__grid">
                  <div className="ns-dialog__qr">
                    {lnurlQr ? (
                      <img src={lnurlQr} alt="LNURL-auth QR code" decoding="async" />
                    ) : (
                  ...
                  <div style={{ display: 'grid', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                      <button type="button" className="ns-btn ns-btn--sm" onClick={handleCopyLnurl}>
