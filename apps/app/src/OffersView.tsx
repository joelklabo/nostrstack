  ...
  return (
    <div className="offers-view">
      <div className="offers-header">
        ...
        <div className="offers-status" role="status" aria-live="polite">
      ...
      <section className="offer-create-card">
        <div className="offer-card-header">
          ...
          <span
            className={`offer-pill ${createStatus === 'loading' ? 'busy' : ''}`}
            role="status"
            aria-live="polite"
          >
      ...
      <section className="offer-list" role="list">
        {offers.length === 0 && (
          <div className="offer-empty" role="status" aria-live="polite">
            <h3>No offers yet</h3>
        ...
        {offers.map((entry) => (
          <article className="offer-card" key={entry.id} role="listitem">
            <div className="offer-card-header">
              <div>
            ...
            <div className="offer-grid">
              ...
              <div className="offer-invoice-column">
                {entry.invoice ? (
                  ...
                  <div className="offer-invoice-placeholder" role="status" aria-live="polite">
