  ...
  return (
    <div className="telemetry-sidebar">
      ...
      <div className="telemetry-status-row" role="status" aria-live="polite">
        <span className="telemetry-status" data-status={displayStatus} aria-label={wsStatusLabel}>
      ...
      {displayStatus === 'offline' && offlineReason && (
        <div className="telemetry-status-note" role="status" aria-live="polite">
      ...
      <div className="telemetry-relays">
        ...
        <div className="telemetry-relays-list" role="list" aria-live="polite">
          {['wss://relay.damus.io', 'wss://relay.snort.social', 'wss://nos.lol'].map((relay) => (
            <div key={relay} className="telemetry-relay-item" role="listitem">
              <div className="telemetry-relay-dot" aria-hidden="true" />
              {relay.replace('wss://', '')}
            </div>
          ))}
        </div>
      ...
      <div className="telemetry-log" role="list" aria-live="polite">
        {logs.length === 0 && (
          <div className="telemetry-log-empty" role="status" aria-live="polite">
            No recent activity...
          </div>
        )}
        {logs.map((log, i) => (
          <div key={i} className={`telemetry-log-entry is-${log.level}`} role="listitem">
