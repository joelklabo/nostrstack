  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
        <Pill label="Mode" value="real relays" tone="success" theme={theme} />
      ...
      <div style={{ marginBottom: '0.5rem', fontSize: '0.9rem', color: '#475569' }}>
        Posting to real relays needs a NIP-07 signer. Don’t have one? <a href="https://getalby.com" target="_blank" rel="noreferrer">Get Alby</a> or use <a href="https://github.com/fiatjaf/nos2x" target="_blank" rel="noreferrer">nos2x</a>.
      </div>
