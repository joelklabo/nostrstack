...
export const AccessibilityDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates accessible modal dialog patterns including focus trap, keyboard navigation, and proper ARIA attributes. Test with keyboard: Tab (focus trap), Escape (close), and verify focus restoration.'
      }
    },
    a11y: {
      config: {
