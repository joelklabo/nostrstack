...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        <img src={Share} alt="A browser window showing a published Storybook" />
        <h4 className="sb-section-item-heading">Publish Storybook</h4>
        <p className="sb-section-item-paragraph">Publish your Storybook to share and collaborate with your entire team.</p>
        <a
          href="https://storybook.js.org/docs/sharing/publish-storybook/?renderer=react&ref=configure"
          target="_blank"
        >Learn more<RightArrow /></a>
      </div>
      <div className="sb-grid-item">
...
<div className="sb-section sb-web-links">
    <div className="sb-section-item">
