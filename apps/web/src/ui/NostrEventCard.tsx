...
const NostrEventCardContent = memo(function NostrEventCard({
  ...
  return (
    ...
    >
      ...
      >
        <header className="ns-event-card__header" data-testid="web-event-header">
      ...
      >
          ...
          <div className="zap-amount-selector" role="radiogroup" aria-label="Zap amount">
            {[21, 50, 100, 500].map((amount) => (
              <button
                ...
                data-testid={`web-zap-amount-${amount}`}
        ...
        <button
          ...
          data-testid="web-event-copy-link"
        ...
        <button
          ...
          data-testid="web-event-source-toggle"
      ...
      {showJson && (
        <div className="ns-event-card__json" data-testid="web-event-json">
  ...
  return (
    <article
      className={['ns-card', 'ns-event-card', `ns-event-card--${variant}`, className]
        .filter(Boolean)
        .join(' ')}
      data-testid="web-event-card-fallback"
