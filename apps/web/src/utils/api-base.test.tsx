...
import { resolveRuntimeApiBase, resolveRuntimeWsUrl, resolveWebApiBase } from './api-base';
...
describe('resolveRuntimeWsUrl', () => {
  ...
  it('preserves localhost:3002 in API base resolution', () => {
    const apiBase = resolveWebApiBase({ apiBase: 'http://localhost:3002' });
