...
4) Start gallery: `VITE_API_BASE_URL=http://localhost:3001 VITE_NOSTRSTACK_HOST=localhost:3001 VITE_NOSTRSTACK_RELAYS=wss://relay.damus.io VITE_ENABLE_REAL_PAYMENTS=true pnpm --filter gallery dev -- --host --port 4173`.
